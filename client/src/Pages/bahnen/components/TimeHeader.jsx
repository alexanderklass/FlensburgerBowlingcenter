...
const TimeHeader = ({
    ...
    return (
        <div className="mt-2 flex md:scale-100 scale-75 justify-center items-center rounded-md bg-[#191919] p-1 text-white">
            <button className={"md:flex hidden"} onClick={handleBackButton}>
                <GoArrowLeft className="self-center text-3xl"/>
            </button>
            <div className="flex flex-row justify-center items-center text-sm">
                <MainButton color={"bg-blue-700 text-[10px] md:text-base"} onClick={handleCreateEvent}>
                    NEUER EINTRAG
                </MainButton>
                <MainButton color={"bg-green-800 text-[10px] md:text-base"} onClick={handleTimeChange}>
                    HEUTE
                </MainButton>
                <input
            ...
            <button className={"md:flex hidden"} onClick={handleNextButton}>

...
const MouseHover = ({
    ...
    return (
        <div className="align-items z-10 md:flex hidden flex-col justify-center">
            {mouseEvent && (
                <div
                    style={{
                    ...
                    className="flex flex-col w-40 rounded border border-black bg-[#191919] p-2 text-white"
                >
                    <p>
                    ...
                    {hoverPayedStatus ? <p className="text-green-500">Bezahlt</p> :
                        <p className="text-red-500">Offene Rechnung</p>}
                </div>
            )}
        </div>
    );
